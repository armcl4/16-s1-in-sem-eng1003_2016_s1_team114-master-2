...
function LocationWeatherCache()
{
    ...
    this.locationAtIndex = function(index) {
     ...
     return locations[index]; }
            ...
            console.log("Index was out of bounds of location array");
        }        
    };
    ...
    this.addLocation = function(latitude, longitude, nickname)
    {
        ...
        var location = function(nickname, latitude, longitude) //function that makes objects with consistent properies. 
        {
        ...
        locations.push(location(nickname, latitude, longitude)); 
